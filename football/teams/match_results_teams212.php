	...
	<div class="content">	
		<div class="container">
			...
			<?php
				...
				$sql = "SELECT scores,match_results.team_id,match_results.league_id,team.team_name,match_fixtures.match_date as matchdate FROM match_results LEFT JOIN team ON match_results.team_id=team.team_id LEFT JOIN match_fixtures on match_results.team_id=match_fixtures.team1_id or match_results.team_id=match_fixtures.team2_id WHERE match_results.match_fixture_id='$match_id' and match_results.league_id='$league_id' GROUP BY team_id";
				...
				if($result->num_rows>0){
					...
					$sql1 = "SELECT match_date from match_fixtures WHERE match_fixture_id='$match_id'";
			...
			<div style="min-height: 100%;">
				<div class="panel panel-primary" >
			    		...
			    		<div class="panel-body">
					    	Use The results under the league table to select an existing record.

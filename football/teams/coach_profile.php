	...
	<div class="container" >
		<div class="row" id="profile_page">
			...
			<div class="col-lg-4">
				<div class="panel panel-default">
					...
					<div class="panel-footer">
						COACH'S NAME: <?php echo $coach_name; ?> <br>
						USERNAME: <?php echo $team_uname; ?> <br>
					</div>
				</div>
			...
			<div class="col-lg-4">
				<div class="panel panel-default">
					<div class="panel-body">
						TEAM ID: <?php echo $team_id; ?><br>
						TEAM NAME: <?php echo $team_name; ?><br>
						PHONE: <?php echo $team_phone; ?> <br>
						EMAIL: <?php echo $team_mail; ?> <br>
					</div>
				</div>
				    ...
				    <div class="modal-content">
				      ...
				      <div class="modal-body">
				        ...
				        <form action="includes/changepassword.inc.php" method="POST" class="form">
				        	...
				        	<input type="hidden" name="uname" value=<?php echo $team_uname; ?> >
...
<!--UPDATE FORM HERE-->
						...
						<form method="post" action="includes\changeprofile.inc.php" enctype="multipart/form-data">
							...
							NAME: 
							<input type="text" name="full_name" class="form-control" value='<?php echo $coach_name; ?>' ><br>
							PHONE:
							<input type="text" name="phone" class="form-control" value=<?php echo $team_phone; ?>><br>
							EMAIL:
							<input type="text" name="mail" class="form-control" value=<?php echo $team_mail; ?>><br>
							<input type="hidden" name="username" value=<?php echo $team_uname; ?> >
							<input type="hidden" name="official_id" value=<?php echo $team_id; ?>>

		...
		<div class="container">
			<div class="row">
				<div class="page-header">
						<center><h1>LIST OF LEAGUES </h1></center>
				</div><br>
					<?php
							//check for an error
							...
							?>
								...
								<tr>
									...
									<td class="form">
										...
										?>
									<a href="list_league_2.php?id=<?php echo $league_id; ?>"><button class="btn btn-info" style=" color:white;">View</button></a>
									</td>
									...
									<td class="form">
										<form action="includes/list_users.del.php" method="POST">
											...
											<button type="submit" class="btn btn-danger"><a href="#"><span class='glyphicon glyphicon-trash'></span></a></button>
										</form>
									</td>
								</tr>

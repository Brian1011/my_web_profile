		...
		<div class="container">
			<div class="row">
				<div class="page-header">
						<center><h1>SELECT A LEAGUE TO SET MATCH</h1></center>
				</div><br>
					<?php
							//check for an error
							...
							?>
								...
								<tr>
									...
									<td class="form">
										...
										?>
									<a href="set_fixtures_p2.php?id=<?php echo $league_id; ?>"><button class="btn btn-default" style="background:grey; color:white;">View</button></a>
									</td>
								</tr>
